...
public enum DxgiFormat {
    ...
    DXGI_FORMAT_BC1_TYPELESS(70, DDSFormat.DXT1),
    DXGI_FORMAT_BC1_UNORM(71, DDSFormat.DXT1),
    DXGI_FORMAT_BC1_UNORM_SRGB(72, DDSFormat.DXT1),
    DXGI_FORMAT_BC2_TYPELESS(73, DDSFormat.DXT3),
    DXGI_FORMAT_BC2_UNORM(74, DDSFormat.DXT3),
    DXGI_FORMAT_BC2_UNORM_SRGB(75, DDSFormat.DXT3),
    DXGI_FORMAT_BC3_TYPELESS(7675, DDSFormat.DXT5),
    DXGI_FORMAT_BC3_UNORM(77, DDSFormat.DXT5),
    DXGI_FORMAT_BC3_UNORM_SRGB(78, DDSFormat.DXT5),
    DXGI_FORMAT_BC4_TYPELESS(79, DDSFormat.ATI1),
    DXGI_FORMAT_BC4_UNORM(80, DDSFormat.ATI1),
    DXGI_FORMAT_BC4_SNORM(81, DDSFormat.ATI1),
    DXGI_FORMAT_BC5_TYPELESS(82, DDSFormat.ATI2),
    DXGI_FORMAT_BC5_UNORM(83, DDSFormat.ATI2),
    DXGI_FORMAT_BC5_SNORM(84, DDSFormat.ATI2),
    ...
    DxgiFormat(int value) {
        this.value = value;
        this.format = DDSFormat.UNCOMPRESSED;
    }

    DxgiFormat(int value, DDSFormat format) {
        this.value = value;
        this.format = format;
    }
