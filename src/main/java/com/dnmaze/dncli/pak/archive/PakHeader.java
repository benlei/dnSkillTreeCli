...
public class PakHeader {
  public static final String START = "EyedentityGames Packing File 0.1";
  ...
  public static PakHeader from(File file) throws IOException {
    ...
    try {
      ...
      if (!Arrays.equals(headerBytes, START.getBytes(StandardCharsets.UTF_8))) {
  ...
  /**
   * <p>The number of files in the archive, according to the header of the pak.</p>
   *
